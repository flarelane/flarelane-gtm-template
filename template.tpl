...
if (!copyFromWindow('FlareLane')) {
  log("FlareLane cannot be found. Please install FlareLane before executing GTM tag. For more details, refer to the Web section of FlareLane Docs.");
}
...
if (method ===  'initialize') {
  ...
  if (projectId) {
    callInWindow(pathToFunction('initialize'), {
      projectId: projectId,
